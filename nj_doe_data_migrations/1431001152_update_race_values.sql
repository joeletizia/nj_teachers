...
ALTER TABLE nj_doe_teachers ALTER race_bl TYPE boolean
USING CASE race_bl WHEN 'Y' THEN TRUE ELSE FALSE END;

ALTER TABLE nj_doe_teachers ALTER race_am TYPE boolean
USING CASE race_am WHEN 'Y' THEN TRUE ELSE FALSE END;

ALTER TABLE nj_doe_teachers ALTER race_pi TYPE boolean
USING CASE race_pi WHEN 'Y' THEN TRUE ELSE FALSE END;

ALTER TABLE nj_doe_teachers ALTER race_as TYPE boolean
